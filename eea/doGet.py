...
class doGet(object):
    def __init__(self, dbMgr):
        ...
        reload(doFlower)
        self.doFlower = doFlower.doFlower(dbMgr)
        reload(doDialog)
        self.doDialog = doDialog.doDialog(dbMgr)
    ...
    def do(self, data):
        try:
            ...
            # delete course
                ...
                return self.doCourse1.do1105(data)
            elif (data["type"] == "1106"):
                return self.doCourse1.do1106(data)
            elif (data["type"] == "1107"):
                return self.doCourse1.do1107(data)
            # get punchClock
            elif (data["type"] == "1201"):
            ...
            # modify punch thumb
                ...
                return self.doCourse1.do1206(data)
            # get score
            elif (data["type"] == "1207"):
                return self.doCourse1.do1207(data)
            # upload comment
            elif (data["type"] == "1300"):
            ...
            # modify comment thumb
            elif (data["type"] == "1307"):
                return self.doCourse1.do1307(data)
            # add usrGrade
            elif (data["type"] == "1400"):
            ...
            # charge flower
                ...
                return self.doFlower.do7000(data)
            # reward
            elif (data["type"] == "7001"):
                return self.doFlower.do7001(data)
            # get flower evnet
            elif (data["type"] == "7100"):
                return self.doFlower.do7100(data)
            # add comment book event
            elif (data["type"] == "7200"):
                return self.doFlower.do7200(data)
            # modify comment book event
            elif (data["type"] == "7201"):
                return self.doFlower.do7201(data)
            # get comment book evnets
            elif (data["type"] == "7300"):
                return self.doFlower.do7300(data)
            # upload dialog
            elif (data["type"] == "2000"):
                return self.doDialog.do2000(data)
            # download dialog
            elif (data["type"] == "2001"):
                return self.doDialog.do2001(data)
