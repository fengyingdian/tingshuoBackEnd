...
import databaseThumb as thb
import databaseFlower as fb
import databaseDialog as ab
import time
import types
import os
...
class databaseManage:
    ...
    def __init__(self):
        ...
        self.thb = thb.databaseThumb(self.db)
        self.fb = fb.databaseFlower(self.db)
        self.ab = ab.databaseDialog(self.db)
    ...
    #
    def addPunchClock(self, courseId, usrId, time, audioSrc, thumb, practice, content, score):
        self.db.insertPunchClock(courseId, usrId, time, audioSrc, thumb, practice, content, score)
    ...
    #
    def addComment(self, punchId, usrId, time, type, content, toUsrId):
        self.db.insertComment(punchId, usrId, time, type, content, toUsrId)
    ...
    def modifyPunchThumb(self, punchId = int(), usrId = int(), time = int(), status = int()):
        return self.thb.modifyPunchThumb(punchId, usrId, time, status)

    #
    def getPunchThumb(self, punchId = int(), usrId = int()):
        return self.thb.getPunchThumb(punchId, usrId)

    #
    def getPunchThumbs(self, punchId = int()):
        return self.thb.getPunchThumbs(punchId)

    #
    def modifyCommentThumb(self, commentId = int(), usrId = int(), time = int(), status = int()):
        return self.thb.modifyCommentThumb(commentId, usrId, time, status)

    #
    def getCommentThumb(self, commentId = int(), usrId = int()):
        return self.thb.getCommentThumb(commentId, usrId)

    #
    def getCommentThumbs(self, commentId = int()):
        return self.thb.getCommentThumbs(commentId)

    #
    def modifyFlower(self, usrId = int(), count = int()):
        return self.fb.modifyFlower(usrId, count)

    #
    def getFlower(self, usrId = int()):
        return self.fb.getFlower(usrId)

    def addFlowerEvent(self, usrId = int(), toUsrId = int(), eventCode = int(), count = int(), time = int()):
        return self.fb.insertFlowerEvent(usrId, toUsrId, eventCode, count, time)

    #
    def getFlowerEventById(self, id = int()):
        return self.fb.getFlowerEventById(id)

    #
    def getFlowerEventByUsrId(self, usrId = int()):
        return self.fb.getFlowerEventByUsrId(usrId)

    #
    def getFlowerEvent(self, usrId = int(), toUsrId = int(), eventCode = int(), time = int()):
        return self.fb.getFlowerEvent(usrId, toUsrId, eventCode, time)

    #
    def addCommentBookEvent(self, usrId = int(), toUsrId = int(), punchId = int(), eventCode = int(), count = int(), time = int()):
        return self.fb.insertCommentBookEvent(usrId, toUsrId, punchId, eventCode, count, time)

    #
    def modifyCommentBookEvent(self, usrId = int(), toUsrId = int(), punchId = int(), eventCode = int(), time = int()):
        return self.fb.modifyCommentBookEvent(usrId, toUsrId, punchId, eventCode, time)

    #
    def getCommentBookEventById(self, id = int()):
        return self.fb.getCommentBookEventById(id)

    #
    def getCommentBookEventByUsrId(self, usrId = int()):
        return self.fb.getCommentBookEventByUsrId(usrId)

    #
    def getCommentBookEventByToUsrId(self, toUsrId = int()):
        return self.fb.getCommentBookEventByToUsrId(toUsrId)

    #
    def getCommentBookEvent(self, usrId = int(), toUsrId = int(), punchId = int(), eventCode = int(), time = int()):
        return self.fb.getCommentBookEvent(usrId, toUsrId, punchId, eventCode, time)

    #
    def addDialog(self, title = str(), name = str(), time = int()):
        return self.ab.insertDialog(title, name, time)
    #
    def getDialog(self, title = str(), name = str()):
        return self.ab.getDialog(title, name)

    #
    def getDialogs(self):
        return self.ab.getDialogs()

    #
    def addDialogContent(self, courseId = int(), character = str(), content = str(), translate=str(), audioSrc=str()):
        return self.ab.insertDialogContent(courseId, character, content, translate, audioSrc)

    #
    def getDialogContentByCourseId(self, courseId = int()):
        return self.ab.getDialogContentByCourseId(courseId)

    #
    def getDialogContent(self, courseId = int(), character = str()):
        return self.ab.getDialogContent(courseId, character)

    #
    def addDialogPunch(self, courseId=int(), usrId=int(), time=int()):
        return self.ab.insertDialogPunch(courseId, usrId, time)

    #
    def getDialogPunch1(self, courseId=int(), usrId=int(), time=int()):
        return self.ab.getDialogPunch1(courseId, usrId, time)

    #
    def getDialogPunch2(self, courseId=int(), usrId=int()):
        return self.ab.getDialogPunch2(courseId, usrId)
    #
    def getDialogPunchByCourseId(self, courseId=int()):
        return self.ab.getDialogPunchByCourseId(courseId)

    #
    def getDialogPunchByUsrId(self, usrId=int()):
        return self.ab.getDialogPunchByUsrId(usrId)

    #
    def insertDialogPunchContent(self, punchId=int(), contentId=int()):
        return self.ab.insertDialogPunchContent(punchId, contentId)

    #
    def getDialogPunchContentByPunchId(self, punchId):
        return self.ab.getDialogPunchContentByPunchId(punchId)

    #
    def getDialogPunchContentById(self, id):
        return self.ab.getDialogPunchContentById(id)
